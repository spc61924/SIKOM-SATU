        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item text-white active">Form Edit Peminjaman</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="pd-30 pd-sm-40 bg-gray-100">
                        <form action="{{ route('update-peminjaman', $data->id) }}" method="post">
                            @csrf
                            @method('put')
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                    <select class="form-control select2" name="buku_id" style="width: 100%">
                                        ...
                                        <option value="{{ $item->id }}" @if($data->buku_id == $item->id) selected @endif>{{ $item->judul }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                    <input class="form-control" placeholder="" type="text" name="tanggal_peminjaman" id="datepickerA" value="{{ \Carbon\Carbon::parse($data->tanggal_peminjaman)->format('Y/m/d') }}">
                                </div>
                            </div>
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                    <input class="form-control" placeholder="" type="text" name="tanggal_pengembalian" id="datepickerA" value="{{ \Carbon\Carbon::parse($data->tanggal_pengembalian)->format('Y/m/d') }}">
                                </div>
                            </div>
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-3">
