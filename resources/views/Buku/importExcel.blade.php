<!-- Modal effects -->
<div class="modal fade effect-scale" id="ModalImportBuku" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
        <form action="{{ route('import-excel-buku') }}" method="post" enctype="multipart/form-data">
            @csrf
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="alert alert-info alert-dismissible fade show" role="alert">
                            ...
                            <span class="alert-inner--text"><strong>Catatan!</strong><br> sistem akan mereplace data jika menginputkan data yang sama dengan data yang sudah tersimpan di aplikasi.</span>
                        ...
                        <div class="row row-xs align-items-center mg-b-20">
                            ...
                            <a href="{{ route('export-excel-buku') }}" class="btn btn-sm btn-secondary" download><i class="fa fa-download me-2"></i> Download Format Excel Import</a>
                            </div>
                        </div>
