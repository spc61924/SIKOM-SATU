                        ...
                        <div class="dropdown main-profile-menu nav nav-item nav-link">
                            ...
                            <div class="dropdown-menu">
                                <div class="main-header-profile header-img">
                                    ...
                                    <h6 style="font-family: Verdana, Geneva, Tahoma, sans-serif">@auth {{ auth()->user()->nama_lengkap }} @endauth</h6><span>@auth {{ auth()->user()->role }} @endauth</span>
                                </div>
                                <a class="dropdown-item" href="{{ route('logout') }}"><i style="margin-left: 66px" class="fas fa-sign-out-alt"></i> Sign Out</a>
                            </div>
                        </div>
                    </div>
                </div>
